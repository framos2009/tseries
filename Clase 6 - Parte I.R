...
#como estimar el var según los criterios de información
var.aic <- VAR(series, 
               type = "none", 
               lag.max = 5, 
               ic = "AIC")
...
# si en módulo los coeficientes estimados para cada variable es > 2 significa que es significativo
...
# CALCULAR EL IMPULSO RESPUESTA - es una función de sensibilidad 
ir.2 <- irf(var_model,
            impulse = "Series.1",  
            response="Series.2",
